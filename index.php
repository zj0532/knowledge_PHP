...
<div action="" class="am-form" id="form-with-tooltip">
	<fieldset>
		...
		<div class="am-form-group">
			...
			<input type="password" id="doc-vld-pwd-1-0" placeholder="密码与OA同步" required data-foolish-msg="把IQ卡密码交出来！" />
		</div>
		
		<button id="from" class="am-btn am-btn-secondary" type="submit">提交</button>
	</fieldset>
</div>
